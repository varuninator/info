...
try {
			...
			if(booked==true){
				...
				result = stmt.executeQuery(str);
				result.next();*/
				String tix = "INSERT otrs.ticket (seat_number, first_name, last_name, first_class, business_class, economy_class) value (" + (result.getInt("seat_number") + 1) + ", \"" + session.getAttribute("first") + "\""+", " +  "\"" + session.getAttribute("last") + "\"" + ", false " + ", true" + ", false" + ")";
				 //out.print(tix);
